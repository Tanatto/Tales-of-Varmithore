...
public class StoneVulcan extends StructureFeature<JigsawConfiguration> {

    public StoneVulcan() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, StoneVulcan::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!StoneVulcan.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            ...
            TalesofVarmithore.LOGGER.log(Level.DEBUG, "StoneVulcan at {}", blockpos);
        }
