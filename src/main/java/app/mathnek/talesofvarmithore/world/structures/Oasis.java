// TODO: Never worked with Jigsaw code, sorry
...
public class Oasis extends StructureFeature<JigsawConfiguration> {

    public Oasis() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, Oasis::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!Oasis.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            ...
            TalesofVarmithore.LOGGER.log(Level.DEBUG, "Oasis at {}", blockpos);
        }
