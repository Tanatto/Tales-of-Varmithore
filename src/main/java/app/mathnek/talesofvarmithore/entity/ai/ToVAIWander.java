...
public class ToVAIWander extends Goal {
    ...
    public ToVAIWander(BaseEntityClass creatureIn, double speedIn) {
        this(creatureIn, speedIn, 20);
    }

    public ToVAIWander(BaseEntityClass creatureIn, double speedIn, int chance) {
