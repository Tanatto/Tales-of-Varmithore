...
public class ToVWaterAvoidingRandomStrollGoal extends RandomStrollGoal {
   RockDrakeEntity dragon;
   public static final float PROBABILITY = 0.001F;
   protected final float probability;

   public ToVWaterAvoidingRandomStrollGoal(RockDrakeEntity dragon, double pSpeedModifier) {
      this(dragon, pSpeedModifier, 0.001F);
      this.dragon = dragon;
   }

   public ToVWaterAvoidingRandomStrollGoal(RockDrakeEntity dragon, double pSpeedModifier, float pProbability) {
