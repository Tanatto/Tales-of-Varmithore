...
public class ControlNetwork {
    ...
    public static void init() {
        ...
        INSTANCE.registerMessage(2, ControlMessageMovingForBite.class, ControlMessageMovingForBite::encode, ControlMessageMovingForBite::decode, ControlMessageMovingForBite::handle);
    }
}
